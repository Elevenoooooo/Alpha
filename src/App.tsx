...
function WorkbenchApp() {
  const { view, setView, resetConversation, productFlow, wikiTask, flash } = useWorkbench();
    ...
    <div className="app-shell">
      ...
      <nav className="mobile-nav" aria-label="移动端主要导航">
        ...
        <div>
          ...
          <button className={view === "wiki" ? "active" : ""} onClick={() => setView("wiki")}><Archive /><span>资产</span></button>
        </div>
      </nav>
